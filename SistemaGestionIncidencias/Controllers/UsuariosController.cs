...
namespace SistemaGestionIncidencias.Controllers
{
    public class UsuariosController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,Nombre,Email,EsTecnico")] Usuario usuario)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "Id,Nombre,Email,EsTecnico")] Usuario usuario)
        {
            if (ModelState.IsValid)
            {
